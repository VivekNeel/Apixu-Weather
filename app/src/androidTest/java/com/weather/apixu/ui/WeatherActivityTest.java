    ...
    public void weatherActivityTest() {
        SystemClock.sleep(5000);
          ViewInteraction textView = onView(
                allOf(withId(R.id.tempText),
                        childAtPosition(
                                allOf(withId(R.id.weatherViewContainer),
                                        childAtPosition(
        ...
        ViewInteraction imageView2 = onView(
                allOf(withId(R.id.conditionIcon),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.forecastList),
                                        0),
        ...
        ViewInteraction textView4 = onView(
                allOf(withId(R.id.conditionTemp),
                        childAtPosition(
                                childAtPosition(
                                        withId(R.id.forecastList),
                                        0),
